...
# Kernel
BOARD_KERNEL_CMDLINE := console=none quiet androidboot.hardware=qcom ehci-hcd.park=3 lpm_levels.sleep_disabled=1 boot_cpus=0-3 androidboot.selinux=enforcing androidboot.verifiedbootstate=green androidboot.veritymode=enforcing androidboot.enable_dm_verity=1 androidboot.secboot=enabled loop.max_part=7 pm.sleep_mode=0
